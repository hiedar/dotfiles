...
#            echo "${fg_bold[gray]}  |_| |_|  |_|\___//_/\_\ ${reset_color}"
        ...
        if shell_has_started_interactively && ! is_ssh_running; then
            ...
            if is_osx && is_exists 'reattach-to-user-namespace'; then
                ...
                tmux -f <(echo "$tmux_config") new-session -n routine \; selectp -t 1 \; send-keys cd\ ~/dotfiles C-m C-l\; splitw -h \; send-keys v\ ~/diary/$(date "+%Y/%m/%d.md") C-m\; selectp -t 1 \; splitw -v \; send-keys cd\ ~/Developer C-m C-l\; selectp -t 1 \; new-window -n work \; splitw -h \; selectp -t 1 \; selectw -t 1
            else
